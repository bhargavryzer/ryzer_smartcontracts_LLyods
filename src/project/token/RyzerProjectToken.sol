...
abstract contract RyzerProjectToken is IToken, TokenStorage, AccessControlUpgradeable {
    /// modifiers
    ...
    /// @dev
    /// @param _config the configuration of the project
    function init(
        ...
        _grantRole(PROJECT_ADMIN_ROLE, _projectOwner);
     ...
     */
    function setName(string calldata _name) external override onlyRole(ADMIN_ROLE) {
     ...
     */
    function setSymbol(string calldata _symbol) external override onlyRole(ADMIN_ROLE) {
     ...
     */
    function setOnchainID(address _onchainID) external override onlyRole(ADMIN_ROLE) {
        _tokenOnchainID = _onchainID;
        emit UpdatedTokenInformation(_tokenName, _tokenSymbol, _tokenDecimals, _TOKEN_VERSION, _tokenOnchainID);
    }
     ...
     *  @dev See {IToken-burn}.
     */
    function burn(address _userAddress, uint256 _amount) public override onlyRole(ADMIN_ROLE) {
     ...
     */
    function setAddressFrozen(address _userAddress, bool _freeze) public override onlyRole(ADMIN_ROLE) {
     ...
     */
    function freezePartialTokens(address _userAddress, uint256 _amount) public override onlyRole(ADMIN_ROLE) {
     ...
     */
    function unfreezePartialTokens(address _userAddress, uint256 _amount) public override onlyRole(ADMIN_ROLE) {
     ...
     */
    function setIdentityRegistry(address _identityRegistry) public override onlyRole(MINTER_ROLE) {
     ...
     */
    function setCompliance(address _compliance) public override onlyRole(MINTER_ROLE) {
