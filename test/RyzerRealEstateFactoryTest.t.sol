...
contract RyzerRealEstateTokenFactoryTest is Test {
    ...
    function test_DeployProject_USDC() public {
        ...
        try factory.deployProject(params, RyzerRealEstateTokenFactory.StableCoin.USDC) 
    ...
    function test_DeployProject_EventEmitted() public {
        ...
        bytes32 projectDeployedEvent = keccak256(
            "ProjectDeployed(address,address,address,address,bytes32,string,address)"
        );
