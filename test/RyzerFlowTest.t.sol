...
contract RyzerFlowTest is Test {
    ...
    function setUp() public {
        ...
        registry = RyzerRegistry(
            address(new ERC1967Proxy(address(registryImpl), ""))
        );
        registry.initialize();
        ...
        companyFactory.deployCompany(
            RyzerCompany.CompanyType.LLC,
            keccak256("Test Company"),
            keccak256("US"),
            keccak256("test-company")
        );
    ...
    function testCompleteFlow() public {
        ...
        (address token, address escrow, address orderManager, address dao) = refactory.deployProject(
            params,
            RyzerRealEstateTokenFactory.StableCoin.USDT
        );
